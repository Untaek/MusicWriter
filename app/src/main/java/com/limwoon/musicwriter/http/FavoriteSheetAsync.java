...
/**
 * Created by 운택 on 2016-10-09.
 */

public class FavoriteSheetAsync extends AsyncTask<Long, Void, Void> {
    ...
    protected Void doInBackground(Long... sheetIds) {
        ...
        try {
            ...
            URL url = new URL(PUBLIC_APP_DATA.getServerUrl()+"favoritemusic.php");
